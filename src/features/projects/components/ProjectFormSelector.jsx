      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50 overflow-y-auto">
        <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-h-[80vh] overflow-y-auto p-8 my-8 relative">
          ...
          <h2 className="text-2xl font-bold text-gray-900 text-center mb-3">
            {t('projectFormSelector.title')}
          </h2>
          <p className="text-gray-600 text-center mb-3">
            {t('projectFormSelector.subtitle')}
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            >
              <div className="flex flex-row">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2 ml-5 self-center">
                  {t('projectFormSelector.guided.title')}
                </h3>
              </div>
              <p className="text-gray-600 mb-4">
                {t('projectFormSelector.guided.description')}
              </p>
              <div className="flex items-center gap-2 text-sm text-gray-500">
                <span className="w-2 h-2 bg-blue-500 rounded-full"></span>
                <span>{t('projectFormSelector.guided.recommended')}</span>
              </div>
            </button>
            ...
            >
              <div className="flex flex-row">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2 ml-5 self-center">
                  {t('projectFormSelector.quick.title')}
                </h3>
              </div>
              <p className="text-gray-600 mb-4">
                {t('projectFormSelector.quick.description')}
              </p>
              <div className="flex items-center gap-2 text-sm text-gray-500">
                <span className="w-2 h-2 bg-green-500 rounded-full"></span>
                <span>{t('projectFormSelector.quick.bestFor')}</span>
              </div>
            </button>
