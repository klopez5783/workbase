    ...
    <div className="p-5 pb-24">
      ...
      <div>
        <div className="flex flex-row items-center gap-2">
          <h2 className="text-xl font-bold text-gray-900 mb-3">{t('nav.Admin Tools')}</h2>
        ...
        <div className="space-y-3">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="font-bold text-gray-900">{t('Hours.title')}</p>
                <p className="text-sm text-gray-600">{t('Hours.ViewHours')}</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="font-bold text-gray-900">{t('reports.dailyReport')}</p>
                <p className="text-sm text-gray-600">{t('reports.viewReports')}</p>
              </div>
            </div>
            <ChevronRight className="text-gray-400" size={20} />
          </button>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="font-bold text-gray-900">{t('reports.submitReport')}</p>
                <p className="text-sm text-gray-600">{t('reports.createReport')}</p>
              </div>
            </div>
            <ChevronRight className="text-gray-400" size={20} />
          </button>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="font-bold text-gray-900">{t('reports.title')}</p>
                <p className="text-sm text-gray-600">{t('reports.createReport')}</p>
              </div>
            </div>
            <ChevronRight className="text-gray-400" size={20} />
